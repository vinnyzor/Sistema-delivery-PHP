...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $sql = "SELECT * FROM admins WHERE email='$usuario' AND senha='$senha'";
        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Bem-vindo Admin! 👋</h4>
              <p class="mb-4">Por favor, entre na sua conta e comece sua adminstração.</p>

            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  <div><strong><?php echo $nome_admin_maiusculo; ?></strong></div>
                </div>
              </div>
              <!-- /Search -->
...
<style>
    ...
    .accordion-body {
        ...
        justify-content: space-between;"><h4 style="caret-color: transparent;" class="card-header">Tickets abertos</h4></div>
    ...
    <div class="table-responsive text-nowrap">
      <div id="ticketsAbertos">
        ...
        <!-- Aqui serão exibidos os tickets abertos -->
                 ...
                 <div class="card mb-4">
               <h4 style="margin-bottom: -30px;" class="card-header">Tickets respondidos</h4>

                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          ...
                          <p class="mb-4">
                            Você solicitou <span class="fw-bold"><?php echo number_format($porcentagemEntregasHoje, 0); ?>%</span> mais entregas hoje. Confira suas entregas.
                          </p>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h5 style="color: #ea1d2c !important" class="card-title text-nowrap mb-2">-R$ 
    ...
    <tr>
      ...
      <td><?php
        ...
        if ($status === 'aguardando_entregador') {
          ...
          echo '<span class="badge bg-label-info me-1">Entrega em rota</span>';

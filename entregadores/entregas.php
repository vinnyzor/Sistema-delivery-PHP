...
$sqlEntregasHoje = "SELECT COUNT(*) AS total_entregas_hoje FROM entregas WHERE entregador='$entregadorId' AND DATE(data_hora) = '$dataAtual'";
...
$sqlEntregasAnteriores = "SELECT COUNT(*) AS total_entregas_anteriores FROM entregas WHERE entregador='$entregadorId' AND DATE(data_hora) < '$dataAtual'";
...
<script src="https://cdn.jsdelivr.net/npm/daterangepicker@3.1.0"></script>
  ...
  <?php endif; ?>
                    ...
                    <li>
                      <a class="dropdown-item" href="lucros.php">
                        <span class="d-flex align-items-center align-middle">
                          <i class="flex-shrink-0 bx bx-credit-card me-2"></i>
                          <span class="flex-grow-1 align-middle">Lucros</span>
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          entregas.forEach(function(entrega) {
            ...
            $('<td>').prepend('R$ ').append(entrega.taxa_entrega_entregador).appendTo(row);

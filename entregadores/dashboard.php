...
if ($result->num_rows === 1) {
  ...
  $nome_maiusculo = mb_strtoupper($nome, 'UTF-8');
...
$sqlEntregasHoje = "SELECT COUNT(*) AS total_entregas_hoje FROM entregas WHERE entregador='$entregadorId' AND DATE(data_hora) = CURDATE()";
...
$sqlEntregasAnteriores = "SELECT COUNT(*) AS total_entregas_anteriores FROM entregas WHERE entregador='$entregadorId' AND DATE(data_hora) < CURDATE()";
...
$sqlEntregas = "SELECT * FROM entregas WHERE entregador='$entregadorId' AND DATE(data_hora) = CURDATE()";
...
<script src="https://cdn.jsdelivr.net/npm/apexcharts@latest"></script>
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  <div><strong><?php echo $nome_maiusculo; ?></strong></div>
                </div>
              </div>
              <!-- /Search -->

              <ul class="navbar-nav flex-row align-items-center ms-auto">
               <strong><div class="cell_test" id="data"></div></strong>&nbsp;-&nbsp;<strong><div class="cell_test" id="hora"></div></strong>
  ...
  <?php endif; ?>
                          ...
                          <div class="flex-grow-1">
                            <span class="fw-semibold d-block"><?php echo $nome_maiusculo; ?></span>
                ...
                <div class="col-lg-8 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Bem vindo, <?php echo $nome; ?> 🎉</h5>
                          <p class="mb-4">
...
$sql = "SELECT COUNT(*) AS total_entregas, SUM(taxa_entrega_entregador) AS total_taxa_entrega, SUM(distancia) AS total_distancia, SUM(CASE WHEN status = 'aguardando_entregador' THEN 1 ELSE 0 END) AS total_em_andamento, SUM(CASE WHEN status = 'em_rota' THEN 1 ELSE 0 END) AS total_em_rota FROM entregas WHERE entregador='$entregadorId' AND DATE(data_hora) = '$date'";
...
if ($result->num_rows > 0) {
    ...
    $totalDistancia = $row["total_distancia"];
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-semibold d-block mb-1">Seu Ranking</span>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h4 style="color: #4acc20 !important" class="card-title text-nowrap mb-2">+R$ 
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-semibold d-block mb-1">Km's no Dia</span>
                          <h4 class="card-title mb-2"><?php echo $totalDistancia; ?> km</h4>
...
$sql = "SELECT DATE_FORMAT(data_hora, '%Y-%m') AS mes, COUNT(*) AS total_entregas FROM entregas WHERE entregador='$entregadorId' AND data_hora >= DATE_FORMAT(DATE_SUB(NOW(), INTERVAL 6 MONTH), '%Y-%m-01') GROUP BY mes";
$result = $conn->query($sql);
